...
* [GitHub Repository](https://github.com/apache/jmeter) ⭐ 9,337 | 🐛 938 | 🌐 Java | 📅 2026-04-08 - Apache JMeter source code repository.
...
* [pymeter](https://github.com/eldaduzman/pymeter) ⭐ 141 | 🐛 6 | 🌐 Python | 📅 2023-12-05 - Simple JMeter performance tests API for Python.
* [jmeter-as-code](https://github.com/anasoid/jmeter-as-code) ⭐ 39 | 🐛 17 | 🌐 Java | 📅 2026-03-14 - Simple wrapper for JMeter to write and execute JMeter tests with Java.
...
* [MeterSphere](https://github.com/metersphere/metersphere) ⭐ 13,099 | 🐛 43 | 🌐 Java | 📅 2026-03-31 - One-stop open-source enterprise-class continuous testing platform, compatible with open-source standards such as JMeter :cn:.
...
* Backend Listener Implementations
  * [jmeter-influxdb2-listener-plugin](https://github.com/mderevyankoaqa/jmeter-influxdb2-listener-plugin) ⭐ 134 | 🐛 51 | 🌐 Java | 📅 2024-08-09 - InfluxDB v2.0 listener plugin for Apache JMeter.
...
* ELK Stack
  * [jmeter-logstash](https://github.com/anasoid/jmeter-logstash) ⭐ 7 | 🐛 6 | 🌐 Shell | 📅 2026-04-08 - Parse JTL result with Docker and Logstash in real time or after test end, and send data to Elasticsearch or InfluxDB, to have a nice dashboard and compare different tests.
...
* [HLS JMeter Plugin](https://github.com/Blazemeter/HLSPlugin) ⭐ 49 | 🐛 16 | 🌐 Java | 📅 2026-04-09
...
* [Awesome Testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,239 | 🐛 2 | 📅 2026-04-08 - A curated list of testing resources.
* [Awesome k6](https://github.com/grafana/awesome-k6) ⭐ 750 | 🐛 4 | 📅 2026-03-05 - Open-source, developer-centric performance monitoring and load testing solution.
* [Awesome Locust](https://github.com/aliesbelik/awesome-locust) ⭐ 112 | 🐛 0 | 📅 2026-03-13 - Open-source scalable load testing framework written in Python.
...
* [Load Testing Toolkit](https://github.com/aliesbelik/load-testing-toolkit) ⭐ 237 | 🐛 0 | 📅 2026-04-06 - Collection of open-source tools for debugging, benchmarking, load and stress testing your code or services.
* [How They Load Test](https://github.com/aliesbelik/how-they-load) ⭐ 157 | 🐛 0 | 📅 2025-12-01 - A curated collection of publicly available resources on how companies around the world perform load testing.
