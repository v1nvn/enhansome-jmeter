...
* [GitHub Repository](https://github.com/apache/jmeter) ⭐ 9,422 | 🐛 953 | 🌐 Java | 📅 2026-06-05 - Apache JMeter source code repository.
...
* [MeterSphere](https://github.com/metersphere/metersphere) ⭐ 13,273 | 🐛 2 | 🌐 Java | 📅 2026-06-12 - One-stop open-source enterprise-class continuous testing platform, compatible with open-source standards such as JMeter :cn:.
...
* [har-convertor-jmeter-tool](https://github.com/vdaburon/har-convertor-jmeter-plugin) ⭐ 24 | 🐛 2 | 🌐 Java | 📅 2026-02-24 - Apache JMeter Plugin to convert a HAR file to a JMeter script and Record XML file.
...
* [JtlReporter](https://github.com/ludeknovy/jtl-reporter) ⭐ 150 | 🐛 2 | 🌐 Python | 📅 2026-04-11 - Online reporting application to generate reports by uploading JTL file.
...
* Backend Listener Implementations
  * [jmeter-influxdb2-listener-plugin](https://github.com/mderevyankoaqa/jmeter-influxdb2-listener-plugin) ⭐ 133 | 🐛 53 | 🌐 Java | 📅 2024-08-09 - InfluxDB v2.0 listener plugin for Apache JMeter.
...
* ELK Stack
  * [jmeter-logstash](https://github.com/anasoid/jmeter-logstash) ⭐ 7 | 🐛 6 | 🌐 Shell | 📅 2026-05-28 - Parse JTL result with Docker and Logstash in real time or after test end, and send data to Elasticsearch or InfluxDB, to have a nice dashboard and compare different tests.
...
* [HLS JMeter Plugin](https://github.com/Blazemeter/HLSPlugin) ⭐ 51 | 🐛 15 | 🌐 Java | 📅 2026-06-09
...
* [Awesome Software Quality](https://github.com/ligurio/sqa-wiki) ⭐ 2,315 | 🐛 0 | 📅 2023-02-01 - A list of free software testing and verification resources.
* [Awesome Testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,288 | 🐛 4 | 📅 2026-06-11 - A curated list of testing resources.
...
* [Load Testing Toolkit](https://github.com/aliesbelik/load-testing-toolkit) ⭐ 243 | 🐛 1 | 📅 2026-06-04 - Collection of open-source tools for debugging, benchmarking, load and stress testing your code or services.
