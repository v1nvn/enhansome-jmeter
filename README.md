...
* [GitHub Repository](https://github.com/apache/jmeter) ⭐ 9,374 | 🐛 946 | 🌐 Java | 📅 2026-04-08 - Apache JMeter source code repository.
...
* [jmeter-as-code](https://github.com/anasoid/jmeter-as-code) ⭐ 39 | 🐛 17 | 🌐 Java | 📅 2026-05-03 - Simple wrapper for JMeter to write and execute JMeter tests with Java.
...
* [MeterSphere](https://github.com/metersphere/metersphere) ⭐ 13,165 | 🐛 44 | 🌐 Java | 📅 2026-03-31 - One-stop open-source enterprise-class continuous testing platform, compatible with open-source standards such as JMeter :cn:.
...
* ELK Stack
  * [jmeter-logstash](https://github.com/anasoid/jmeter-logstash) ⭐ 7 | 🐛 6 | 🌐 Shell | 📅 2026-04-30 - Parse JTL result with Docker and Logstash in real time or after test end, and send data to Elasticsearch or InfluxDB, to have a nice dashboard and compare different tests.
...
* [Awesome Testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,262 | 🐛 2 | 📅 2026-04-22 - A curated list of testing resources.
* [Awesome k6](https://github.com/grafana/awesome-k6) ⭐ 756 | 🐛 1 | 📅 2026-04-29 - Open-source, developer-centric performance monitoring and load testing solution.
...
* [How They Load Test](https://github.com/aliesbelik/how-they-load) ⭐ 159 | 🐛 0 | 📅 2025-12-01 - A curated collection of publicly available resources on how companies around the world perform load testing.
