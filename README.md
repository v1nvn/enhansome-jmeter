...
* [GitHub Repository](https://github.com/apache/jmeter) ⭐ 9,219 | 🐛 935 | 🌐 Java | 📅 2026-01-12 - Apache JMeter source code repository.
...
* [MeterSphere](https://github.com/metersphere/metersphere) ⭐ 12,928 | 🐛 44 | 🌐 Java | 📅 2026-02-06 - One-stop open-source enterprise-class continuous testing platform, compatible with open-source standards such as JMeter :cn:.
...
* Prometheus
  * [jmeter-prometheus-plugin](https://github.com/johrstrom/jmeter-prometheus-plugin) ⭐ 184 | 🐛 36 | 🌐 Java | 📅 2023-08-03 - A Prometheus Listener for Apache JMeter that exposes results in HTTP API.
...
* Backend Listener Implementations
  ...
  * [jmeter-datadog-backend-listener](https://github.com/DataDog/jmeter-datadog-backend-listener) ⭐ 13 | 🐛 10 | 🌐 Java | 📅 2026-01-29 - Send JMeter test results to Datadog.
