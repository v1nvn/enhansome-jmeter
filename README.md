...
* [GitHub Repository](https://github.com/apache/jmeter) ⭐ 9,402 | 🐛 953 | 🌐 Java | 📅 2026-05-26 - Apache JMeter source code repository.
...
* [MeterSphere](https://github.com/metersphere/metersphere) ⭐ 13,232 | 🐛 1 | 🌐 Java | 📅 2026-05-25 - One-stop open-source enterprise-class continuous testing platform, compatible with open-source standards such as JMeter :cn:.
...
* [JMeter Maven Plugin](https://github.com/jmeter-maven-plugin/jmeter-maven-plugin) ⭐ 438 | 🐛 20 | 🌐 Java | 📅 2025-01-03 - Maven plugin that provides the ability to run JMeter tests as part of the build.
...
* Prometheus
  * [jmeter-prometheus-plugin](https://github.com/johrstrom/jmeter-prometheus-plugin) ⭐ 188 | 🐛 36 | 🌐 Java | 📅 2023-08-03 - A Prometheus Listener for Apache JMeter that exposes results in HTTP API.
...
* Backend Listener Implementations
  * [jmeter-influxdb2-listener-plugin](https://github.com/mderevyankoaqa/jmeter-influxdb2-listener-plugin) ⭐ 133 | 🐛 52 | 🌐 Java | 📅 2024-08-09 - InfluxDB v2.0 listener plugin for Apache JMeter.
  ...
  * [jmeter-datadog-backend-listener](https://github.com/DataDog/jmeter-datadog-backend-listener) ⭐ 13 | 🐛 9 | 🌐 Java | 📅 2026-05-08 - Send JMeter test results to Datadog.
...
* ELK Stack
  * [jmeter-logstash](https://github.com/anasoid/jmeter-logstash) ⭐ 7 | 🐛 6 | 🌐 Shell | 📅 2026-05-12 - Parse JTL result with Docker and Logstash in real time or after test end, and send data to Elasticsearch or InfluxDB, to have a nice dashboard and compare different tests.
...
* [HLS JMeter Plugin](https://github.com/Blazemeter/HLSPlugin) ⭐ 51 | 🐛 15 | 🌐 Java | 📅 2026-04-20
...
* [JMeter Viewer](https://github.com/anboralabs/intellij-jmeter) ⭐ 5 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Open JMeter test plans inside IntelliJ IDE.
...
* [JEval](https://github.com/QAInsights/JEval) ⭐ 33 | 🐛 0 | 🌐 Python | 📅 2020-10-21 - A Python-based utility which evaluates JMeter test plan and provides recommendations and best practices by analyzing each element.
...
* [Awesome Testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,276 | 🐛 7 | 📅 2026-05-27 - A curated list of testing resources.
* [Awesome k6](https://github.com/grafana/awesome-k6) ⭐ 761 | 🐛 2 | 📅 2026-04-29 - Open-source, developer-centric performance monitoring and load testing solution.
...
* [Awesome Gatling](https://github.com/aliesbelik/awesome-gatling) ⭐ 78 | 🐛 0 | 📅 2026-03-10 - Open-source load and performance testing framework based on Scala, Akka and Netty.
...
* [Load Testing Toolkit](https://github.com/aliesbelik/load-testing-toolkit) ⭐ 240 | 🐛 0 | 📅 2026-04-06 - Collection of open-source tools for debugging, benchmarking, load and stress testing your code or services.
* [How They Load Test](https://github.com/aliesbelik/how-they-load) ⭐ 163 | 🐛 0 | 📅 2025-12-01 - A curated collection of publicly available resources on how companies around the world perform load testing.
